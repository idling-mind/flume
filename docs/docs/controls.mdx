...
An object representing all of the data for the inputs of the current port. This can be useful for rendering controls which rely on the current values of controls in other inputs.
